...
const buildPosCrudOpenApi = createCrudOpenApiFactory({
    defaultTag: 'POS',
...
export function createPosCrudOpenApi(options: CrudOpenApiOptions): OpenApiRouteDoc {
    return buildPosCrudOpenApi(options)
}

...
| `wic-evaluator` | Calculate or replay-test Open Mercato WIC scores from GitHub evidence using the official WIC Assessment Guide and the local fetcher / freeze / compare scripts. Use for monthly contribution scoring and assessment-guide regression tests. |
